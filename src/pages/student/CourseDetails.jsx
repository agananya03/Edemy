...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateChapterTime, calculateCourseDuration, calculateNoOfLectures} = useAppContext()
              ...
              {courseData.courseContent.map((chapter, index) => (
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  ...
                  <div className='overflow-hidden transition-all duration-300 max-h-96'>
                    <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-6 border-t border-gray-300'>
