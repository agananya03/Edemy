...
const CalltoAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0' >
      ...
      <p className='text-gray-500 sm:text-sm'>Access high-quality courses tailored to your pace and goals. Empower your learning journey with interactive, expert-led content.</p>
